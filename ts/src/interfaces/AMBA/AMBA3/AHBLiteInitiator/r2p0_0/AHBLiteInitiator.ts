...
export class AHBLiteInitiator extends Interface {
  declare params: AHBLiteInitiator_Parameters
  declare signals: AHBLiteIntiator_Signals
  /**
   * VLNV Metadata
   */
   ...
   * or just a bundle of interconnect wires
   */
  constructor (params: AHBLiteInitiator_Parameters = {}, role: AHBLiteInitiator_Role = undefined) {
    super(
      'AHBLiteInitiator',
      {
