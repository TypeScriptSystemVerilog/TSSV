...
/**
 * Interface defining the parameters of the CHI_B_SNI_rtl TSSV Interface bundle
 */
export interface CHI_B_SNI_rtl_Parameters extends TSSVParameters {
  /**
 ...
 */
export type CHI_B_SNI_rtl_Role = 'master' | 'slave' | undefined

/**
 * TSSV Interface bundle for the CHI_B_SNI_rtl protocol
 */
export class CHI_B_SNI_rtl extends Interface {
  declare params: CHI_B_SNI_rtl_Parameters
  /**
   * VLNV Metadata
   */
  ...
  /**
   * Create a new CHI_B_SNI_rtl Interface bundle with either master or slave port interface
   * or just a bundle of interconnect wires
   * @param params param value set
   * @param role sets the role of this instance to choose master or slave port interface
   * or just a bundle of interconnect wires
   */
  constructor (params: CHI_B_SNI_rtl_Parameters = {}, role: CHI_B_SNI_rtl_Role = undefined) {
    super(
      'CHI_B_SNI_rtl',
      {
        AIW: params.AIW || 8,
