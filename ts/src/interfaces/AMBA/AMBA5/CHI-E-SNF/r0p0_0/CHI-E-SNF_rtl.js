...
exports.CHI_E_SNF_rtl = void 0;
var TSSV_1 = require("tssv/lib/core/TSSV");
/**
 * TSSV Interface bundle for the CHI_E_SNF_rtl protocol
 */
var CHI_E_SNF_rtl = /** @class */ (function (_super) {
    __extends(CHI_E_SNF_rtl, _super);
    /**
     ...
     * or just a bundle of interconnect wires
     */
    function CHI_E_SNF_rtl(params, role) {
        if (params === void 0) { params = {}; }
        if (role === void 0) { role = undefined; }
        var _this = _super.call(this, 'CHI_E_SNF_rtl', {
            AIW: params.AIW || 8,
            AW: params.AW || 32,
            DIW: params.DIW || 8,
            DW: params.DW || 32
    ...
    return CHI_E_SNF_rtl;
}(TSSV_1.Interface));
exports.CHI_E_SNF_rtl = CHI_E_SNF_rtl;
