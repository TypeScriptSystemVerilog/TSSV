 ...
 */
export class ACE5_Lite_rtl extends Interface {
  declare params: ACE5_Lite_rtl_Parameters
  /**
   * VLNV Metadata
   */
   ...
   * or just a bundle of interconnect wires
   */
  constructor (params: ACE5_Lite_rtl_Parameters = {}, role: ACE5_Lite_rtl_Role = undefined) {
    super(
      'ACE5_Lite_rtl',
      {
        AIW: params.AIW || 8,
