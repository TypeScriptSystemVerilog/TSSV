...
exports.ACE5_Lite_rtl = void 0;
var TSSV_1 = require("tssv/lib/core/TSSV");
/**
 * TSSV Interface bundle for the ACE5_Lite_rtl protocol
 */
var ACE5_Lite_rtl = /** @class */ (function (_super) {
    __extends(ACE5_Lite_rtl, _super);
    /**
     ...
     * or just a bundle of interconnect wires
     */
    function ACE5_Lite_rtl(params, role) {
        if (params === void 0) { params = {}; }
        if (role === void 0) { role = undefined; }
        var _this = _super.call(this, 'ACE5_Lite_rtl', {
            AIW: params.AIW || 8,
            AW: params.AW || 32,
            DIW: params.DIW || 8,
            DW: params.DW || 32
    ...
    return ACE5_Lite_rtl;
}(TSSV_1.Interface));
exports.ACE5_Lite_rtl = ACE5_Lite_rtl;
