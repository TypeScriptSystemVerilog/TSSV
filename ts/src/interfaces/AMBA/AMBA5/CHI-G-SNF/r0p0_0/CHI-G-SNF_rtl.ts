 ...
 */
export class CHI_G_SNF_rtl extends Interface {
  declare params: CHI_G_SNF_rtl_Parameters
  /**
   * VLNV Metadata
   */
   ...
   * or just a bundle of interconnect wires
   */
  constructor (params: CHI_G_SNF_rtl_Parameters = {}, role: CHI_G_SNF_rtl_Role = undefined) {
    super(
      'CHI_G_SNF_rtl',
      {
        AIW: params.AIW || 8,
