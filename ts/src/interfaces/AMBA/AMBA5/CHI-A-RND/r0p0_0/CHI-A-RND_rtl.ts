 ...
 */
export class CHI_A_RND_rtl extends Interface {
  declare params: CHI_A_RND_rtl_Parameters
  /**
   * VLNV Metadata
   */
   ...
   * or just a bundle of interconnect wires
   */
  constructor (params: CHI_A_RND_rtl_Parameters = {}, role: CHI_A_RND_rtl_Role = undefined) {
    super(
      'CHI_A_RND_rtl',
      {
        AIW: params.AIW || 8,
    ...
    this.signals = {
      ...
      RXSNPFLIT_SrcID: { width: 7 },
      RXSNPFLIT_TxnID: { width: 8 },
      RXSNPFLIT_Opcode: { width: 4 },
      RXSNPFLIT_Addr: { width: 41 },
