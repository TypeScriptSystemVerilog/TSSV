 ...
 */
export class CHI_B_RNI_rtl extends Interface {
  declare params: CHI_B_RNI_rtl_Parameters
  /**
   * VLNV Metadata
   */
   ...
   * or just a bundle of interconnect wires
   */
  constructor (params: CHI_B_RNI_rtl_Parameters = {}, role: CHI_B_RNI_rtl_Role = undefined) {
    super(
      'CHI_B_RNI_rtl',
      {
        AIW: params.AIW || 8,
