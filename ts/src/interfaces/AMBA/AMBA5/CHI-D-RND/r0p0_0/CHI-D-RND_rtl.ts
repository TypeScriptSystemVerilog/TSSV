 ...
 */
export class CHI_D_RND_rtl extends Interface {
  declare params: CHI_D_RND_rtl_Parameters
  /**
   * VLNV Metadata
   */
   ...
   * or just a bundle of interconnect wires
   */
  constructor (params: CHI_D_RND_rtl_Parameters = {}, role: CHI_D_RND_rtl_Role = undefined) {
    super(
      'CHI_D_RND_rtl',
      {
        AIW: params.AIW || 8,
    ...
    this.signals = {
      ...
      RXSNPFLIT_TxnID: { width: 10 },
      RXSNPFLIT_FwdNID: { width: params.DIW || 8 },
      RXSNPFLIT_FwdTxnID: { width: 10 },
