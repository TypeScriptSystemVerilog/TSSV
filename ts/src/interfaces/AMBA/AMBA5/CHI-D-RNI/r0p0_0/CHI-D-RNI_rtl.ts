 ...
 */
export class CHI_D_RNI_rtl extends Interface {
  declare params: CHI_D_RNI_rtl_Parameters
  /**
   * VLNV Metadata
   */
   ...
   * or just a bundle of interconnect wires
   */
  constructor (params: CHI_D_RNI_rtl_Parameters = {}, role: CHI_D_RNI_rtl_Role = undefined) {
    super(
      'CHI_D_RNI_rtl',
      {
        AIW: params.AIW || 8,
