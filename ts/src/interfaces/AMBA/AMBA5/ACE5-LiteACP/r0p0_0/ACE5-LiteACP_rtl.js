...
exports.ACE5_LiteACP_rtl = void 0;
var TSSV_1 = require("tssv/lib/core/TSSV");
/**
 * TSSV Interface bundle for the ACE5_LiteACP_rtl protocol
 */
var ACE5_LiteACP_rtl = /** @class */ (function (_super) {
    __extends(ACE5_LiteACP_rtl, _super);
    /**
     ...
     * or just a bundle of interconnect wires
     */
    function ACE5_LiteACP_rtl(params, role) {
        if (params === void 0) { params = {}; }
        if (role === void 0) { role = undefined; }
        var _this = _super.call(this, 'ACE5_LiteACP_rtl', {
            AIW: params.AIW || 8,
            AW: params.AW || 32,
            DIW: params.DIW || 8,
            DW: params.DW || 32
    ...
    return ACE5_LiteACP_rtl;
}(TSSV_1.Interface));
exports.ACE5_LiteACP_rtl = ACE5_LiteACP_rtl;
