 ...
 */
export class CHI_F_RND_rtl extends Interface {
  declare params: CHI_F_RND_rtl_Parameters
  /**
   * VLNV Metadata
   */
   ...
   * or just a bundle of interconnect wires
   */
  constructor (params: CHI_F_RND_rtl_Parameters = {}, role: CHI_F_RND_rtl_Role = undefined) {
    super(
      'CHI_F_RND_rtl',
      {
        AIW: params.AIW || 8,
