 ...
 */
export class CHI_G_RNF_rtl extends Interface {
  declare params: CHI_G_RNF_rtl_Parameters
  /**
   * VLNV Metadata
   */
   ...
   * or just a bundle of interconnect wires
   */
  constructor (params: CHI_G_RNF_rtl_Parameters = {}, role: CHI_G_RNF_rtl_Role = undefined) {
    super(
      'CHI_G_RNF_rtl',
      {
        AIW: params.AIW || 8,
    ...
    this.signals = {
      ...
      TXREQFLIT_MPAM: { width: params.DIW || 8 },
      TXREQFLIT_PBHA: { width: 4 },
      TXREQFLIT_MECID: { width: 16 },
      TXREQFLIT_SecSID1: { width: 1 },
      ...
      RXSNPFLIT_TxnID: { width: 12 },
      RXSNPFLIT_FwdNID: { width: params.DIW || 8 },
      RXSNPFLIT_FwdTxnID: { width: 12 },
      RXSNPFLIT_Opcode: { width: 5 },
      RXSNPFLIT_Addr: { width: params.AW || 32 },
      RXSNPFLIT_NS: { width: 1 },
      RXSNPFLIT_NSE: { width: 1 },
      RXSNPFLIT_DoNotGoToSD: { width: 1 },
      RXSNPFLIT_RetToSrc: { width: 1 },
      RXSNPFLIT_TraceTag: { width: 1 },
      RXSNPFLIT_MPAM: { width: params.DIW || 8 },
      RXSNPFLIT_MECID: { width: 16 },
      RXSNPLCRDV: { width: 1 },
      RXSNPFLITPENDCHK: { width: 1 },
      RXSNPFLITVCHK: { width: 1 },
      RXSNPFLITCHK: { width: params.DIW || 8 },
      RXSNPLCRDVCHK: { width: 1 },
      SYSCOREQ: { width: 1 },
      SYSCOACK: { width: 1 },
      SYSCOREQCHK: { width: 1 },
      SYSCOACKCHK: { width: 1 }
    ...
    this.modports = {
      master: {
        ...
        TXREQFLIT_MECID: 'output',
        TXREQFLIT_SecSID1: 'output',
        ...
        RXSNPFLIT_MPAM: 'input',
        RXSNPFLIT_MECID: 'input',
        RXSNPLCRDV: 'output',
        RXSNPFLITPENDCHK: 'input',
        RXSNPFLITVCHK: 'input',
        RXSNPFLITCHK: 'input',
        RXSNPLCRDVCHK: 'output',
        SYSCOREQ: 'output',
        SYSCOACK: 'input',
        SYSCOREQCHK: 'output',
        SYSCOACKCHK: 'input'
      ...
      slave: {
        ...
        TXREQFLIT_MECID: 'input',
        TXREQFLIT_SecSID1: 'input',
        ...
        RXSNPFLIT_NS: 'output',
        RXSNPFLIT_NSE: 'output',
        RXSNPFLIT_DoNotGoToSD: 'output',
        RXSNPFLIT_RetToSrc: 'output',
        RXSNPFLIT_TraceTag: 'output',
        RXSNPFLIT_MPAM: 'output',
        RXSNPFLIT_MECID: 'output',
        RXSNPLCRDV: 'input',
        RXSNPFLITPENDCHK: 'output',
        RXSNPFLITVCHK: 'output',
        RXSNPFLITCHK: 'output',
        RXSNPLCRDVCHK: 'input',
        SYSCOREQ: 'input',
        SYSCOACK: 'output',
