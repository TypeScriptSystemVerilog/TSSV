...
exports.ACE5_LiteDVM_rtl = void 0;
var TSSV_1 = require("tssv/lib/core/TSSV");
/**
 * TSSV Interface bundle for the ACE5_LiteDVM_rtl protocol
 */
var ACE5_LiteDVM_rtl = /** @class */ (function (_super) {
    __extends(ACE5_LiteDVM_rtl, _super);
    /**
     ...
     * or just a bundle of interconnect wires
     */
    function ACE5_LiteDVM_rtl(params, role) {
        if (params === void 0) { params = {}; }
        if (role === void 0) { role = undefined; }
        var _this = _super.call(this, 'ACE5_LiteDVM_rtl', {
            AIW: params.AIW || 8,
            AW: params.AW || 32,
            DIW: params.DIW || 8,
            DW: params.DW || 32
     ...
     * VLNV Metadata
     */
    ACE5_LiteDVM_rtl.VLNV = {
        vendor: 'amba.com',
        library: 'AMBA5',
        name: 'ACE5-LiteDVM_rtl',
        version: 'r0p0_0'
    };
    return ACE5_LiteDVM_rtl;
}(TSSV_1.Interface));
exports.ACE5_LiteDVM_rtl = ACE5_LiteDVM_rtl;
