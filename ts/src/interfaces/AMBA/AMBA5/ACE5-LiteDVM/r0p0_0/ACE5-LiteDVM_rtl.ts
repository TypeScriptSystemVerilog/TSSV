 ...
 */
export class ACE5_LiteDVM_rtl extends Interface {
  declare params: ACE5_LiteDVM_rtl_Parameters
  /**
   * VLNV Metadata
   */
   ...
   * or just a bundle of interconnect wires
   */
  constructor (params: ACE5_LiteDVM_rtl_Parameters = {}, role: ACE5_LiteDVM_rtl_Role = undefined) {
    super(
      'ACE5_LiteDVM_rtl',
      {
        AIW: params.AIW || 8,
