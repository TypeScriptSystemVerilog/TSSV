...
exports.AHB5Target_rtl = void 0;
var TSSV_1 = require("tssv/lib/core/TSSV");
/**
 * TSSV Interface bundle for the AHB5Target_rtl protocol
 */
var AHB5Target_rtl = /** @class */ (function (_super) {
    __extends(AHB5Target_rtl, _super);
    /**
     ...
     * or just a bundle of interconnect wires
     */
    function AHB5Target_rtl(params, role) {
        if (params === void 0) { params = {}; }
        if (role === void 0) { role = undefined; }
        var _this = _super.call(this, 'AHB5Target_rtl', {
            AIW: params.AIW || 8,
            AW: params.AW || 32,
            DIW: params.DIW || 8,
            DW: params.DW || 32
    ...
    return AHB5Target_rtl;
}(TSSV_1.Interface));
exports.AHB5Target_rtl = AHB5Target_rtl;
