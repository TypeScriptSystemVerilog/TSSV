 ...
 */
export class ACE_Lite_WO extends Interface {
  declare params: ACE_Lite_WO_Parameters
  declare signals: ACE_Lite_WO_Signals
  /**
   * VLNV Metadata
   */
   ...
   * or just a bundle of interconnect wires
   */
  constructor (params: ACE_Lite_WO_Parameters = {}, role: ACE_Lite_WO_Role = undefined) {
    super(
      'ACE_Lite_WO',
      {
