...
/**
 * Interface defining the parameters of the ACE_Lite_WO_rtl TSSV Interface bundle
 */
export interface ACE_Lite_WO_rtl_Parameters extends TSSVParameters {
  /**
 ...
 */
export type ACE_Lite_WO_rtl_Role = 'master' | 'slave' | undefined

/**
 * TSSV Interface bundle for the ACE_Lite_WO_rtl protocol
 */
export class ACE_Lite_WO_rtl extends Interface {
  declare params: ACE_Lite_WO_rtl_Parameters
  /**
   * VLNV Metadata
   */
  static readonly VLNV = {
    vendor: 'amba.com',
    library: 'AMBA4',
    name: 'ACE-Lite_WO_rtl',
    version: 'r0p0_0'
  }

  /**
   * Create a new ACE_Lite_WO_rtl Interface bundle with either master or slave port interface
   * or just a bundle of interconnect wires
   * @param params param value set
   * @param role sets the role of this instance to choose master or slave port interface
   * or just a bundle of interconnect wires
   */
  constructor (params: ACE_Lite_WO_rtl_Parameters = {}, role: ACE_Lite_WO_rtl_Role = undefined) {
    super(
      'ACE_Lite_WO_rtl',
      {
        AIW: params.AIW || 8,
