...
/**
 * Interface defining the parameters of the AXI4_WO_rtl TSSV Interface bundle
 */
export interface AXI4_WO_rtl_Parameters extends TSSVParameters {
  /**
...
export class AXI4_WO_rtl extends Interface {
   ...
   * or just a bundle of interconnect wires
   */
  constructor (params: AXI4_WO_rtl_Parameters = {}, role: AXI4_WO_rtl_Role = undefined) {
    super(
      'AXI4_WO_rtl',
      {
        AIW: params.AIW || 8,
