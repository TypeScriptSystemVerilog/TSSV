...
/**
 * Interface defining the parameters of the ACE_Lite TSSV Interface bundle
 */
export interface ACE_Lite_Parameters extends TSSVParameters {
...
export interface ACE_Lite_Signals extends Signals {
  ACLK: { width: 1 }
  ACLKEN: { width: 1 }
  ARESETn: { width: 1 }
  AWID: Signal
 ...
 */
export type ACE_Lite_Role = 'outward' | 'inward' | undefined

/**
 * TSSV Interface bundle for the ACE_Lite protocol
 */
export class ACE_Lite extends Interface {
  declare params: ACE_Lite_Parameters
  declare signals: ACE_Lite_Signals
  /**
   * VLNV Metadata
   */
   ...
   * or just a bundle of interconnect wires
   */
  constructor (params: ACE_Lite_Parameters = {}, role: ACE_Lite_Role = undefined) {
    super(
      'ACE_Lite',
      {
