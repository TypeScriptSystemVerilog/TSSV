...
/**
 * Interface defining the parameters of the ACE_Lite_rtl TSSV Interface bundle
 */
export interface ACE_Lite_rtl_Parameters extends TSSVParameters {
  /**
...
export class ACE_Lite_rtl extends Interface {
   ...
   * or just a bundle of interconnect wires
   */
  constructor (params: ACE_Lite_rtl_Parameters = {}, role: ACE_Lite_rtl_Role = undefined) {
    super(
      'ACE_Lite_rtl',
      {
        AIW: params.AIW || 8,
