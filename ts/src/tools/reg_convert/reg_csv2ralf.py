...
block_bytes = 4
dst_filename = '/home/runzhe.liu/opentitan/hw/dv/tools/ralgen/ralfgen/AIGC_DEMO_Reg.ralf'
csv_filename = '/home/runzhe.liu/opentitan/hw/dv/tools/ralgen/ralfgen/AIGC_DEMO_Reg.csv'
...
with open(dst_filename, 'w') as file_obj:
    ...
    # 写入 block 的开头部分
    file_obj.write("block AIGC_DEMO_Reg {\n")
