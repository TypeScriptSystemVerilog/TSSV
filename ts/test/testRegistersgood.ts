...
type RegMapEntry = [string, string]
type RegMap = RegMapEntry[]

// const rawRegMap: RegMap = JSON.parse(fs.readFileSync(regMapFilePath, 'utf8')) as RegMap

// const myRegMap = Object.fromEntries(
//   rawRegMap.map(([key, value]: [string, string]) => {
...
const myRegs: RegisterBlockDef<typeof myRegMap> = {
  ...
  registers: {
    ...
    REG1: {
      ...
      width: 16, // output logic signed [15:0] REG1,
      isSigned: true
    },
    REG2: {
      type: 'RW',
