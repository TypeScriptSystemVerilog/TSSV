...
/* verilator lint_off WIDTHEXPAND */        
    module ROM_32_big_split2two_lower     #(parameter dataWidth = 32)
       (
       input logic  clk,
   input logic  rd_en,
...
/* verilator lint_off WIDTHTRUNC */
/* verilator lint_off WIDTHEXPAND */        
    module ROM_32_big_split2two_upper     #(parameter dataWidth = 32)
       (
       input logic  clk,
   input logic  rd_en,
   input logic  addr,
...
/* verilator lint_off WIDTHTRUNC */
/* verilator lint_off WIDTHEXPAND */        
    module ROM_32_big_split2two     #(parameter dataWidth = 32)
       (
       input logic  clk,
   input logic  rd_en,
