...
/* verilator lint_off WIDTHEXPAND */        
    module Adder_8_8     #(parameter aWidth = 8,
    parameter bWidth = 8)
       (
...
/* verilator lint_off WIDTHTRUNC */
/* verilator lint_off WIDTHEXPAND */        
    module Adder_8_9     #(parameter aWidth = 8,
    parameter bWidth = 9)
       (
       input logic signed [7:0] a,
...
/* verilator lint_off WIDTHTRUNC */
/* verilator lint_off WIDTHEXPAND */        
    module Adder3_8_8_8     #(parameter aWidth = 8,
    parameter bWidth = 8,
    parameter cWidth = 8)
       (
       input logic signed [7:0] a,
   ...
   logic [9:0] sum_d3;
   logic [9:0] sum_d4;
   logic signed [4:0] testSignExtend = -5;
   logic signed [7:0] ext_w3s_testSignExtend;
   logic [9:0] sum_d5;
   logic signed [7:0] const_w8sm32 = -32;
