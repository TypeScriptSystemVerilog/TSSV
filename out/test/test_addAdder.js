...
`;
const add_tb = new Module({ name: 'add_tb' }, {
...
`;
const addS_tb = new Module({ name: 'addS_tb' }, {
    clk: { direction: 'input', isClock: 'posedge' },
    rst_b: { direction: 'input', isReset: 'lowasync' }
}, {}, tbBodyS);
...
`;
const addUS_tb = new Module({ name: 'addUS_tb' }, {
    clk: { direction: 'input', isClock: 'posedge' },
    rst_b: { direction: 'input', isReset: 'lowasync' }
}, {}, tbBodyUS);
...
`;
const addSU_tb = new Module({ name: 'addSU_tb' }, {
    clk: { direction: 'input', isClock: 'posedge' },
    rst_b: { direction: 'input', isReset: 'lowasync' }
}, {}, tbBodySU);
...
`;
const addB_tb = new Module({ name: 'sub_tb' }, {
    clk: { direction: 'input', isClock: 'posedge' },
    rst_b: { direction: 'input', isReset: 'lowasync' }
}, {}, tbBodyB);
