...
`);
const romModule = new Module({ name: 'rom_32x32' }, {
    clk: { direction: 'input', isClock: 'posedge' },
    rst_b: { direction: 'input', isReset: 'lowasync' },
    addr: { direction: 'input', width: 32 },
    re: { direction: 'input' },
...
tb_testRegBlock.addSubmodule('ram_inst', ramModule, {}, true, true);
tb_testRegBlock.addSubmodule('rom_inst', romModule, {}, true, true);
...
`;
const tb_testRegBlock2 = new Module({ name: 'tb_testRegBlock2' }, {
    clk: { direction: 'input', isClock: 'posedge' },
    rst_b: { direction: 'input', isReset: 'lowasync' }
}, {}, tbBody2);
tb_testRegBlock2.addSubmodule('ram_inst', ramModule, {}, true, true);
tb_testRegBlock2.addSubmodule('rom_inst', romModule, {}, true, true);
...
`;
const tb_testRegBlock3 = new Module({ name: 'tb_testRegBlock3' }, {
    clk: { direction: 'input', isClock: 'posedge' },
    rst_b: { direction: 'input', isReset: 'lowasync' }
}, {}, tbBody3);
tb_testRegBlock3.addSubmodule('ram_inst', ramModule, {}, true, true);
...
`;
const tb_testRegBlock4 = new Module({ name: 'tb_testRegBlock4' }, {
    clk: { direction: 'input', isClock: 'posedge' },
    rst_b: { direction: 'input', isReset: 'lowasync' }
}, {}, tbBody4);
tb_testRegBlock4.addSubmodule('ram_inst', ramModule, {}, true, true);
