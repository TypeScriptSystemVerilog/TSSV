 ...
 */
export declare class AXI4Stream_rtl extends Interface {
    params: AXI4Stream_rtl_Parameters;
    /**
     * VLNV Metadata
     */
     ...
     * or just a bundle of interconnect wires
     */
    constructor(params?: AXI4Stream_rtl_Parameters, role?: AXI4Stream_rtl_Role);
}
