...
/**
 * Interface defining the parameters of the APB5_rtl TSSV Interface bundle
 */
export interface APB5_rtl_Parameters extends TSSVParameters {
    /**
 ...
 */
export type APB5_rtl_Role = 'master' | 'slave' | undefined;
/**
 * TSSV Interface bundle for the APB5_rtl protocol
 */
export declare class APB5_rtl extends Interface {
    params: APB5_rtl_Parameters;
    /**
     * VLNV Metadata
     */
     ...
     * or just a bundle of interconnect wires
     */
    constructor(params?: APB5_rtl_Parameters, role?: APB5_rtl_Role);
}
