...
/**
 * Interface defining the parameters of the CHI_C_RNI_rtl TSSV Interface bundle
 */
export interface CHI_C_RNI_rtl_Parameters extends TSSVParameters {
    /**
 ...
 */
export type CHI_C_RNI_rtl_Role = 'master' | 'slave' | undefined;
/**
 * TSSV Interface bundle for the CHI_C_RNI_rtl protocol
 */
export declare class CHI_C_RNI_rtl extends Interface {
    params: CHI_C_RNI_rtl_Parameters;
    /**
     * VLNV Metadata
     */
     ...
     * or just a bundle of interconnect wires
     */
    constructor(params?: CHI_C_RNI_rtl_Parameters, role?: CHI_C_RNI_rtl_Role);
}
