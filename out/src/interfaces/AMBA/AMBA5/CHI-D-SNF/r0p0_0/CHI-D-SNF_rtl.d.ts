...
/**
 * Interface defining the parameters of the CHI_D_SNF_rtl TSSV Interface bundle
 */
export interface CHI_D_SNF_rtl_Parameters extends TSSVParameters {
    /**
 ...
 */
export type CHI_D_SNF_rtl_Role = 'master' | 'slave' | undefined;
/**
 * TSSV Interface bundle for the CHI_D_SNF_rtl protocol
 */
export declare class CHI_D_SNF_rtl extends Interface {
    params: CHI_D_SNF_rtl_Parameters;
    /**
     * VLNV Metadata
     */
     ...
     * or just a bundle of interconnect wires
     */
    constructor(params?: CHI_D_SNF_rtl_Parameters, role?: CHI_D_SNF_rtl_Role);
}
