...
/**
 * Interface defining the parameters of the AHB5Target_rtl TSSV Interface bundle
 */
export interface AHB5Target_rtl_Parameters extends TSSVParameters {
    /**
 ...
 */
export type AHB5Target_rtl_Role = 'master' | 'slave' | undefined;
/**
 * TSSV Interface bundle for the AHB5Target_rtl protocol
 */
export declare class AHB5Target_rtl extends Interface {
    params: AHB5Target_rtl_Parameters;
    /**
     * VLNV Metadata
     */
     ...
     * or just a bundle of interconnect wires
     */
    constructor(params?: AHB5Target_rtl_Parameters, role?: AHB5Target_rtl_Role);
}
