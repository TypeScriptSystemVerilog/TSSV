...
/**
 * Interface defining the parameters of the ACE5_rtl TSSV Interface bundle
 */
export interface ACE5_rtl_Parameters extends TSSVParameters {
    /**
 ...
 */
export type ACE5_rtl_Role = 'master' | 'slave' | undefined;
/**
 * TSSV Interface bundle for the ACE5_rtl protocol
 */
export declare class ACE5_rtl extends Interface {
    params: ACE5_rtl_Parameters;
    /**
     * VLNV Metadata
     */
     ...
     * or just a bundle of interconnect wires
     */
    constructor(params?: ACE5_rtl_Parameters, role?: ACE5_rtl_Role);
}
