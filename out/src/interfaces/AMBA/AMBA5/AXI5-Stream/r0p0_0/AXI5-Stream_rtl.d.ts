 ...
 */
export declare class AXI5_Stream_rtl extends Interface {
    params: AXI5_Stream_rtl_Parameters;
    /**
     * VLNV Metadata
     */
     ...
     * or just a bundle of interconnect wires
     */
    constructor(params?: AXI5_Stream_rtl_Parameters, role?: AXI5_Stream_rtl_Role);
}
