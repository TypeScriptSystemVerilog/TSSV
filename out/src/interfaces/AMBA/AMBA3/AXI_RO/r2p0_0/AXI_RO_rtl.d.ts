...
/**
 * Interface defining the parameters of the AXI_RO_rtl TSSV Interface bundle
 */
export interface AXI_RO_rtl_Parameters extends TSSVParameters {
    /**
 ...
 */
export type AXI_RO_rtl_Role = 'master' | 'slave' | undefined;
/**
 * TSSV Interface bundle for the AXI_RO_rtl protocol
 */
export declare class AXI_RO_rtl extends Interface {
    params: AXI_RO_rtl_Parameters;
    /**
     * VLNV Metadata
     */
     ...
     * or just a bundle of interconnect wires
     */
    constructor(params?: AXI_RO_rtl_Parameters, role?: AXI_RO_rtl_Role);
}
