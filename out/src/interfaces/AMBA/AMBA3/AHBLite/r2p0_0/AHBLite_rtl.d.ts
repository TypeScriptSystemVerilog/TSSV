...
/**
 * Interface defining the parameters of the AHBLite_rtl TSSV Interface bundle
 */
export interface AHBLite_rtl_Parameters extends TSSVParameters {
    /**
 ...
 */
export type AHBLite_rtl_Role = 'master' | 'slave' | undefined;
/**
 * TSSV Interface bundle for the AHBLite_rtl protocol
 */
export declare class AHBLite_rtl extends Interface {
    params: AHBLite_rtl_Parameters;
    /**
     * VLNV Metadata
     */
     ...
     * or just a bundle of interconnect wires
     */
    constructor(params?: AHBLite_rtl_Parameters, role?: AHBLite_rtl_Role);
}
